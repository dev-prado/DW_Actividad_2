...
?>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <p>
        Tu sexo es: <b><?php echo Sexo($sexo); ?></b>
      </p>
      <p>
        Tu <b><?php echo ($terminos == 1 ? 'sí' : 'no'); ?></b> aceptaste los términos y condiciones.
      </p>
      <p>
        Tu <b><?php echo ($terminos == 1 ? 'sí' : 'no'); ?></b> aceptaste recibir correo basura
      </p>
    </div>
